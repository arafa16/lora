...
Route::get('/dashboard/{id}', [DashboardController::class, 'view_kolam']);

//data user admin
Route::get('/data_user', [AdminController::class, 'index']);
Route::get('/user_regist/{id}', [AdminController::class, 'user_regist']);
Route::get('/user_active/{id}', [AdminController::class, 'user_active']);
Route::get('/user_non_active/{id}', [AdminController::class, 'user_non_active']);
Route::get('/user_delete/{id}', [AdminController::class, 'user_delete']);

Route::post('/create_kolam', [KolamController::class, 'create_kolam']);
